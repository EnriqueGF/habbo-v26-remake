...
<ul>
    @if($section === 'home')
        ...
        <li class="{{ $active === 'hand' ? 'selected' : '' }}">@if($active === 'hand')Vac&iacute;a tu mano @else<a href="/deletehand">Vac&iacute;a tu mano</a>@endif</li>
    ...
    @elseif($section === 'credits')
        ...
        <li class="{{ $active === 'hand' ? 'selected' : '' }}">@if($active === 'hand')Vac&iacute;a tu mano @else<a href="/deletehand">Vac&iacute;a tu mano</a>@endif</li>
        <li class="{{ $active === 'collectables' ? 'selected' : '' }}">@if($active === 'collectables')Collectors @else<a href="/collectables">Collectors</a>@endif</li>
        <li class="last"><a href="/pixels">Pixels</a></li>
    @endif
</ul>
