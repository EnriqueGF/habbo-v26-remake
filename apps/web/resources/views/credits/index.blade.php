    ...
    <div id="column2" class="column">
        ...
        <div class="habblet-container">
            <div class="cbb clearfix orange">
                <h2 class="title">&iquest;Qu&eacute; son los cr&eacute;ditos de {{ $shortname }}?</h2>
                <div id="credits-promo" class="box-content credits-info">
                    <div class="credit-info-text clearfix">
                        ...
                        <p class="credits-text">Los cr&eacute;ditos de {{ $shortname }} son la moneda del hotel. Sirven para comprar todo tipo de cosas, desde un pato de goma hasta un teletransportador.</p>
                    </div>
