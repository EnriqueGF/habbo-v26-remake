...
include('templates/community/subheader2.php');
...
<?php	} ?>
        <li class="selected"><a href="<?php if($row['forumid'] != 0) { echo "group_"; } ?>forum.php<?php if($row['forumid'] != 0) { ?>?id=<?php echo $groupid; } ?>">Foro de discusi&oacute;n </a><span class="tab-spacer"></span></li>
    </ul>
</div>
...
<div id="group-postlist-container">
    ...
    <div class="postlist-header clearfix">
				...
				$zxcv = "";
				if($row['topics'] == 0) {
					$asdf = "<a href=\"#\" id=\"create-post-message\" class=\"create-post-link verify-email\">Responder</a>";
					$zxcv = "<a href=\"#\" class=\"quote-post-link verify-email\" id=\"quote-post-".$row['id']."-message\">Citar</a>";
				}elseif($row['topics'] == 1) {
				...
				?>
                <?php if($topic_open && $logged_in){ ?><?php echo $asdf ?><?php } elseif($logged_in) { ?><span class="topic-closed"><img src="./web-gallery/images/groups/status_closed.gif" title="Hilo cerrado"> Hilo cerrado</span><?php } ?>
				...
				if(mysql_num_rows($hid) > 0) { ?><a href="#" id="edit-topic-settings" class="edit-topic-settings-link">Herramientas de moderaci&oacute;n &raquo;</a>
                <input type="hidden" id="settings_dialog_header" value="Herramientas de moderaci&oacute;n"/>
				<?php
				}elseif($user_rank > 5){ ?><a href="#" id="edit-topic-settings" class="edit-topic-settings-link">Herramientas de moderaci&oacute;n &raquo;</a>
...
<div id="new-post-preview" style="display:none;">
    ...
    <div class="postlist-footer clearfix">
		<?php if($topic_open && $logged_in){ ?><?php echo $asdf ?></a><?php } elseif($logged_in){ ?><span class="topic-closed"><img src="./web-gallery/images/groups/status_closed.gif" title="Hilo cerrado"> Hilo cerrado</span><?php } else { echo "</a>Debes estar conectado para responder o publicar nuevos temas."; } ?>
...
Las marcas, copyright y bases de datos del sitio Habbo, as&iacute; como su contenido, son propiedad de Sulake Inc.<br /><strong>HRW Cms, una producci&oacute;n de <a href="http://habboretroweb.net">HabboRetroWeb</a>. Creado por Victor. Todos los derechos reservados.</strong><br />
</div></div>
...
Event.observe("dialog-group-settings-exit", "click", function(e) {
	...
	<h2 class="title dialog-handle">Verificaci&oacute;n</h2>
	...
	<p>Verifica tu cuenta antes de publicar.</p>
	<p class="clearfix">
		<a href="#" id="postentry-verifyemail-ok" class="new-button"><b>Cancelar</b><i></i></a>
	</p>
	</div>
</div>	
...
<form method="post" id="postentry-delete-form">
	...
	<p>&iquest;Est&aacute;s seguro de que quieres eliminar este mensaje? Esta acci&oacute;n no se puede deshacer.</p>
	<p class="clearfix">
		<a href="#" id="postentry-delete-cancel" class="new-button"><b>Cancelar</b><i></i></a>
		<a href="#" id="postentry-delete" class="new-button"><b>Continuar</b><i></i></a>
	</p>
</form>
	</div>
</div>	
