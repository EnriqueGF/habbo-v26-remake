...
<div class="avatar-list-avatar"><img src="/habbo-imaging/avatarimage?figure=<?php echo $friend['figure']; ?>&size=s&direction=2&head_direction=2&gesture=sml" alt="" /></div>
...
?>
    ...
    <a href="#" class="avatar-list-paging-link" id="avatarlist-search-last" >&Uacute;ltimo</a>
	<?php }else{ ?>
	&gt;&gt; |
    &Uacute;ltimo
	<?php } ?>
...
<div class="avatar-list-avatar"><img src="/habbo-imaging/avatarimage?figure=<?php echo $friendrow['figure']; ?>&size=s&direction=2&head_direction=2&gesture=sml" alt="" /></div>
