...
while($membership_row = mysql_fetch_assoc($get_groups)){
	...
	echo "	<li title=\"".$grouprow['name']."\" id=\"groups-list-".$saved_id."-".$grouprow['id']."\">
		...
		<p>
		Grupo creado:<br />";
		if($membership_row['is_current'] == 1){ echo "<div class=\"favourite-group\" title=\"Favorito\"></div>\n"; }
		if($membership_row['member_rank'] > 1 && $grouprow['ownerid'] !== $my_id){ echo "<div class=\"admin-group\" title=\"Admin\"></div>\n"; }
		if($grouprow['ownerid'] == $my_id && $membership_row['member_rank'] > 1){ echo "<div class=\"owned-group\" title=\"Propietario\"></div>\n"; }
...
<?php echo $edit; ?>
		...
		<span class="header-left">&nbsp;</span><span class="header-middle">MIS HABITACIONES</span><span class="header-right">&nbsp;</span></h3>
		</div>	
	</div>
	<div class="widget-body">
		<div class="widget-content">
...
<table border="0" cellpadding="0" cellspacing="0">
			...
			while ($roomrow = mysql_fetch_assoc($roomsql)) {
				...
				if($roomrow['state'] == 2){
					$qwer = "password";
					$zxcv = "con contrase&ntilde;a";
				} elseif($roomrow['state'] == 0){
					$qwer = "open";
					$zxcv = "entrar a la habitaci&oacute;n";
...
<td $asdf>
		...
		<br class="clear" />
			...
			echo "No tienes ninguna habitaci&oacute;n.";
		} ?>
		<div class="clear"></div>
		</div>
	</div>
...
<div class="w_skin_defaultskin">
	<div class="widget-corner" id="widget-<?php echo $saved_id ?>-handle">
		<div class="widget-headline"><h3>
		<?php echo $edit; ?>
		<span class="header-left">&nbsp;</span><span class="header-middle">Mi libro de visitas(<span id="guestbook-size">0</span>) <span id="guestbook-type" class="public"><img src="./images/groups/status_exclusive.gif" title="Solo amigos" alt="Solo amigos"/></span></span><span class="header-right">&nbsp;</span></h3>
		</div>	
	</div>
	<div class="widget-body">
		<div class="widget-content">
...
<div class=\"w_skin_defaultskin\">
	<div class=\"widget-corner\" id=\"widget-".$saved_id."-handle\">
		<div class=\"widget-headline\"><h3><span class=\"header-left\">&nbsp;</span><span class=\"header-middle\">Mis amigos (<span id=\"avatar-list-size\">".$count."</span>)</span><span class=\"header-right\">".$edit."</span></h3>
		</div>
	</div>
	<div class=\"widget-body\">
		<div class=\"widget-content\">\n";
...
<div class="w_skin_defaultskin">
	<div class="widget-corner" id="widget-<?php echo $saved_id ?>-handle">
		<div class="widget-headline"><h3><?php echo $edit; ?><span class="header-left">&nbsp;</span><span class="header-middle">MEJORES PUNTUACIONES</span><span class="header-right">&nbsp;</span></h3>
		</div>	
	</div>
	<div class="widget-body">
		<div class="widget-content">
	...
	if($bbrow['bb_playedgames'] == "0"){
		echo "No has jugado a ning&uacute;n juego todav&iacute;a.";
	}else{ ?>
	<table>
			<tr colspan="2">
				<th>Battle Ball</a></th>
...
<div class="w_skin_defaultskin">
	<div class="widget-corner" id="widget-<?php echo $saved_id ?>-handle">
		<div class="widget-headline"><h3><?php echo $edit; ?><span class="header-left">&nbsp;</span><span class="header-middle">Insignias</span><span class="header-right">&nbsp;</span></h3>
		</div>	
	</div>
	<div class="widget-body">
		<div class="widget-content">
	...
	if($count == 0){
		echo "No tienes ninguna insignia.";
	}else{
	?>
    <?php
	$bypass1 = true;
