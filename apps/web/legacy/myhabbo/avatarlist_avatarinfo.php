...
<div class="avatar-list-info-container">
	<div class="avatar-info-basic clearfix">
		...
		?>
			<img src="/habbo-imaging/avatarimage?figure=<?php echo $row['figure']; ?>&size=l&direction=4&head_direction=4" alt="<?php echo $row['name']; ?>" />
		</div>
...
<p><?php echo $shortname; ?> creado el: <b><?php echo $row['hbirth']; ?></b></p>
<p><a href="./user_profile.php?name=<?php echo $row['name']; ?>" class="arrow">Ver la p&aacute;gina de <?php echo $shortname; ?></a></p>
