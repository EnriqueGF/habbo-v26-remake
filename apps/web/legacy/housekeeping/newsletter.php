...
$msg = "Se intent&oacute; enviar el bolet&iacute;n a ".$i." usuarios.";
}
...
<div class='tableheaderalt'>Redactar bolet&iacute;n</div>

<table width='100%' cellspacing='0' cellpadding='5' align='center' border='0'>
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Asunto</b><div class='graytext'>El asunto del bolet&iacute;n.</div></td>
...
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Cl&aacute;usula WHERE</b><div class='graytext'>Para usuarios avanzados, la cl&aacute;usula WHERE de la consulta MySQL para obtener usuarios. &iexcl;NO EDITES A MENOS QUE SEPAS LO QUE HACES!</div></td>
...
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Cuerpo</b><div class='graytext'>El cuerpo del bolet&iacute;n. (&iexcl;La cabecera y el pie ya est&aacute;n incluidos!)<br />Se permite HTML. Usa %name% para el nombre del usuario.</div></td>
...
<tr>
<tr><td align='center' class='tablesubheader' colspan='2' ><input type='submit' value='Publicar bolet&iacute;n' class='realbutton' accesskey='s'></td></tr>
</form></table></div><br />
	 </div><!-- / RIGHT CONTENT BLOCK -->
	 </td></tr>
</table>
