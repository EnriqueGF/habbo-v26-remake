...
if(isset($_POST['alert'])){
    if(!empty($_POST['alert'])){
        ...
        $msg = "Aviso masivo enviado. Usuarios procesados: " . $counter;
    } else {
        $msg = "No dejes el campo de aviso en blanco.";
    }
}
...
<div class='tableheaderalt'>Aviso masivo del sitio</div>
...
<tr>
<td class='tablerow1' width='40%' valign='middle'><strong>Aviso del servidor</strong><div class='graytext'>Si marcas esto, el aviso tambi&eacute;n se enviar&aacute; a los usuarios conectados en el servidor como alerta MOD. En ese caso, no uses HTML.</div></td>
