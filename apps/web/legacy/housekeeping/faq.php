...
if($_GET['cat'] != ""){
	...
	$msg = "Categor&iacute;a eliminada.";
...
<?php if($page == "main"){ ?>
 ...
 <div class='tableheaderalt'>Categor&iacute;as de FAQ</div>
 <table cellpadding='4' cellspacing='0' width='100%'>
 <tr>
  <td class='tablesubheader' width='10%' align='center'>ID</td>
  <td class='tablesubheader' width='25%' align='center'>Nombre</td>
  <td class='tablesubheader' width='55%' align='center'>Descripci&oacute;n</td>
...
<tr>
  ...
  <td class='tablerow2' align='center'><a href='index.php?p=faq&key=<?php echo $row['id']; ?>&edit=cat'><img src='./images/edit.gif' alt='Editar'></a> <a href='index.php?p=faq&key=<?php echo $row['id']; ?>&delete=cat'><img src='./images/delete.gif' alt='Eliminar'></a></td>
</tr>
<?php } ?>
 
 </table>
 <div class='tablefooter' align='center'><div class='fauxbutton-wrapper'><span class='fauxbutton'><a href='index.php?p=faq&edit=cat'>Crear nueva categor&iacute;a</a></span></div></div>
</div>
...
<div class='tableborder'>
<div class='tableheaderalt'>Editar/Crear categor&iacute;a</div>
<?php
if(isset($_GET['key'])){
...
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>T&iacute;tulo</b><div class='graytext'>El t&iacute;tulo de tu categor&iacute;a.</div></td>
<td class='tablerow2'  width='60%'  valign='middle'><input type='text' name='title' value="<?php echo $title; ?>" size='30' class='textinput'></td>
</tr>

<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Contenido</b><div class='graytext'>El contenido que se muestra al hacer clic.<br />El HTML s&iacute; est&aacute; permitido.</div></td>
...
?>
 <div class='tableborder'>
 <div class='tableheaderalt'>Elementos de: <?php echo $row['title']; ?></div>
 <table cellpadding='4' cellspacing='0' width='100%'>
 <tr>
  <td class='tablesubheader' width='10%' align='center'>ID</td>
  <td class='tablesubheader' width='40%' align='center'>Tema</td>
  <td class='tablesubheader' width='40%' align='center'>Contenido</td>
...
<tr>
  ...
  <td class='tablerow2' align='center'><a href='index.php?p=faq&key=<?php echo $row1['id']; ?>&edit=item'><img src='./images/edit.gif' alt='Editar'></a> <a href='index.php?p=faq&key=<?php echo $row1['id']; ?>&delete=item'><img src='./images/delete.gif' alt='Eliminar'></a></td>
</tr>
<?php } ?>
 
 </table>
 <div class='tablefooter' align='center'><div class='fauxbutton-wrapper'><span class='fauxbutton'><a href='index.php?p=faq&catid=<?php echo $id; ?>&edit=item'>Crear nuevo elemento</a></span></div></div>
</div>
<?php }elseif($page == "edititem"){ ?>
<?php if(isset($msg)){ ?><p><strong><?php echo $msg; ?></strong></p><?php } ?>
<form action='index.php?p=faq&do=saveitem' method='post' name='theAdminForm' id='theAdminForm'>
<div class='tableborder'>
<div class='tableheaderalt'>Editar/Crear elemento</div>
<?php
if(isset($_GET['key'])){
	$row = mysql_fetch_assoc(mysql_query("SELECT * FROM cms_faq WHERE id = '".$_GET['key']."' LIMIT 1"));
	$topic = $row['title'];
...
<table width='100%' cellspacing='0' cellpadding='5' align='center' border='0'>
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Tema</b><div class='graytext'>El tema de tu elemento.</div></td>
