...
if(isset($_POST['query'])){
	...
	if($results > 0 && is_numeric($amount)){
		...
		$msg = "Se han dado " . $amount . " cr&eacute;ditos al usuario " . $name . ".";
		...
		$msg = "La cantidad no es v&aacute;lida o este usuario no existe.";
...
<div class='tableheaderalt'>Dar cr&eacute;ditos / Reembolsos</div>

<table width='100%' cellspacing='0' cellpadding='5' align='center' border='0'>
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><strong>Nombre de usuario</strong><div class='graytext'>El nombre o ID del usuario al que quieres dar los cr&eacute;ditos.</div></td>
<td class='tablerow2'  width='60%'  valign='middle'><input type='text' name='query' value="" size='30' class='textinput'></td>
</tr>

<tr>
<td class='tablerow1'  width='40%'  valign='middle'><strong>Cantidad</strong><div class='graytext'>La cantidad de cr&eacute;ditos que quieres dar.</div></td>
<td class='tablerow2'  width='60%'  valign='middle'><input type='text' name='amount' value="" size='30' class='textinput'></td>
</tr>

<tr>
<tr><td align='center' class='tablesubheader' colspan='2' ><input type='submit' value='Dar cr&eacute;ditos' class='realbutton' accesskey='s'></td></tr>
</form></table></div><br />
