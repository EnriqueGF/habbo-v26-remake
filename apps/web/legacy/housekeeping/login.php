...
if(isset($_POST['username'])){
	...
	if(!empty($form_name) && !empty($form_pass)){
		if($valid > 0){
			...
			$msg = "Contrase&ntilde;a incorrecta";
		}
	} else {
	...
	$msg = "Sesi&oacute;n cerrada correctamente";
} else {
	$msg = "No se ha encontrado ninguna sesi&oacute;n de administraci&oacute;n";
}
...
<tr>
 ...
 <input type='hidden' name='qstring' value='' />
  ...
  <tr>
   ...
   <br />
  	<div style='font-size:9px;color:gray'>Esta p&aacute;gina est&aacute; reservada al equipo de <?php echo $shortname; ?>. Si no formas parte del equipo de <?php echo $shortname; ?>, por favor identif&iacute;cate.<br /><br />Si has olvidado tu contrase&ntilde;a, <a href='../forgot.php'>haz clic aqu&iacute;</a> o contacta con el administrador</div>
   </div>
   </td>
   <td width='300' style='width:300px' valign='top'>
	 ...
	 <tr>		<td align='right'><strong>Usuario</strong></td>	  <td><input style='border:1px solid #AAA' type='text' size='20' name='username' id='namefield' value='<?php if(!isset($_POST['username'])){ echo $name; } else { echo htmlentities($_POST['username'],ENT_QUOTES); } ?>' /></td>
	 </tr>
	 <tr>
