...
$msg = "Recomendado a&ntilde;adido.";
}else{
...
<div class='tableheaderalt'><?php if($_GET['a'] == "add"){ echo "A&ntilde;adir "; }elseif($_GET['a'] == "edit") { echo "Editar "; } ?>Recomendado</div>

<table width='100%' cellspacing='0' cellpadding='5' align='center' border='0'>
<?php if($_GET['a'] == "add") { ?>
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Tipo</b><div class='graytext'>Escribe 'group' o 'room' (a&uacute;n no disponible)</div></td>
...
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>ID</b><div class='graytext'>El ID de la recomendaci&oacute;n.</div></td>
...
<?php if(isset($_GET['a']) && !isset($_GET['key'])) {
		if($_GET['a'] == "edit") {
echo "Si deseas editar un recomendado, ve a la vista general y haz clic en el icono de editar.";
	}
}	?>
<tr>
<tr><td align='center' class='tablesubheader' colspan='2' ><input type='submit' name='<?php if($_GET['a'] == "add") { echo "add"; }else{ echo "edit"; } ?>' value='<?php if($_GET['a'] == "add") { echo "A&ntilde;adir recomendado"; }else{ echo "Editar recomendado"; } ?>' class='realbutton' accesskey='s'></td></tr>
