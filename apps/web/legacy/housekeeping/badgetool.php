	...
	if($exists > 0){
		...
		if(strlen($badge) > 2 && strlen($badge) < 5){
			...
			if($already_has_badge < 1){
				...
				$msg = "Se ha dado la placa (" . $badge . ") al usuario y se ha establecido como placa actual correctamente.";
				...
				$msg = "Este usuario ya tiene esta placa; la placa (" . $badge . ") se ha establecido como la placa actual del usuario correctamente.";
			...
			$msg = "Placa inv&aacute;lida. Los c&oacute;digos de placa solo pueden tener 3-4 caracteres.";

		}

	} else {

		$msg = "No existe ning&uacute;n usuario con ese nombre/ID.";
...
<div class='tableheaderalt'>Gestor de placas</div>

<table width='100%' cellspacing='0' cellpadding='5' align='center' border='0'>
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><strong>Username</strong><div class='graytext'>El nombre de usuario al que se aplicar&aacute; esta acci&oacute;n.</div></td>
<td class='tablerow2'  width='60%'  valign='middle'><input type='text' name='name' value="" size='30' class='textinput'></td>
</tr>

<tr>
<td class='tablerow1'  width='40%'  valign='middle'><strong>Badgecode</strong><div class='graytext'>El c&oacute;digo de placa, p. ej. 'ADM' o 'XM8'.</div></td>
<td class='tablerow2'  width='60%'  valign='middle'><input type='text' name='badge' value="" size='30' class='textinput'></td>
</tr>

<tr>
<tr><td align='center' class='tablesubheader' colspan='2' ><input type='submit' value='Dar placa' class='realbutton' accesskey='s'></td></tr>
</form></table></div><br />
