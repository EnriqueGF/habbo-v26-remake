...
if(isset($_POST['query'])){
    ...
    $msg = "Operaci&oacute;n aplicada correctamente. Baneos afectados: " . $rows;
}
...
<div class='tableheaderalt'>Desbanear (masivo)</div>

<table width='100%' cellspacing='0' cellpadding='5' align='center' border='0'>
    
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Direcci&oacute;n IP</b> O <b>ID de usuario</b> O <b>Fecha de caducidad</b> O <b>Motivo</b><div class='graytext'>Variable que debe contener el baneo para desbanearlo.</div></td>
...
<tr>
<tr><td align='center' class='tablesubheader' colspan='2' ><input type='submit' value='Desbanear' class='realbutton' accesskey='s'></td></tr>
