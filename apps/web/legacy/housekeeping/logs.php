...
<?php @include('usermenu.php'); ?>
 ...
 <div class='tableheaderalt'><?php echo $sitename; ?> Registros del staff</div>
 <table cellpadding='4' cellspacing='0' width='100%'>
 <tr>
  <td class='tablesubheader' width='15%' align='center'>Acci&oacute;n</td>
  <td class='tablesubheader' width='15%' align='center'>Usuario</td>
  <td class='tablesubheader' width='15%' align='center'>Usuario objetivo</td>
  <td class='tablesubheader' width='25%'>Mensaje/Detalles</td>
  <td class='tablesubheader' width='15%'>Nota</td>
  <td class='tablesubheader' width='20%' align='center'>Fecha</td>
 </tr>
<?php
...
while($row = mysql_fetch_assoc($get_users)){
	...
	if(!empty($row['note'])){ $note = $row['note']; } else { $note = "<i>Ninguna</i>"; }
...
<br />
<div align='center'>(<a href='index.php?p=logs&do=prune'><b>Limpiar registros</b></a>)</div>
	 </div><!-- / RIGHT CONTENT BLOCK -->
	 </td></tr>
</table>
</div><!-- / OUTERDIV -->
