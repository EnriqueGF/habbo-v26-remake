...
if($do == "delete" && is_numeric($key)){
	...
	if($exists > 0){
		...
		$msg = "Art&iacute;culo eliminado correctamente.";
	} else {
		$msg = "No se puede eliminar el art&iacute;culo; este art&iacute;culo no existe.";
	}
	...
	if($exists > 0){
		...
		$msg = "No se puede editar el art&iacute;culo; este art&iacute;culo no existe.";
	}
	...
	if($exists > 0){
		...
		$msg = "Art&iacute;culo actualizado correctamente.";
		$editor_mode = false;
	...
	$msg = "Art&iacute;culo publicado correctamente.";
...
<form action='index.php?p=news_manage&do=save' method='post' name='theAdminForm' id='theAdminForm'>
 ...
 <div class='tableheaderalt'>Art&iacute;culos</div>
 <table cellpadding='4' cellspacing='0' width='100%'>
 <tr>
  <td class='tablesubheader' width='1%' align='center'>ID</td>
  <td class='tablesubheader' width='28%'>T&iacute;tulo</td>
  <td class='tablesubheader' width='10%' align='center'>Date</td>
  <td class='tablesubheader' width='10%' align='center'>Autor</td>
  <td class='tablesubheader' width='10%' align='center'>Editar</td>
  <td class='tablesubheader' width='12%' align='center'>Eliminar</td>
 </tr>
<?php
...
while($row = mysql_fetch_assoc($get_articles)){
  ...
  <td class='tablerow2' align='center'>%s</td>
  <td class='tablerow2' align='center'><a href='index.php?p=news_manage&do=edit&key=%s'><img src='./images/edit.gif' alt='Editar'></a></td>
  <td class='tablerow2' align='center'><a href='index.php?p=news_manage&do=delete&key=%s'><img src='./images/delete.gif' alt='Eliminar'></a></td>
</tr>", $row['num'], HoloText($row['title']), FilterText($row['short_story']), $row['date'], $row['author'], $row['num'], $row['num']);
}
?>

 </table>
 <div class='tablefooter' align='center'><div class='fauxbutton-wrapper'><span class='fauxbutton'><a href='index.php?p=news_compose'>Redactar una nueva noticia</a></span></div></div>
</div>
<?php } else { ?>
<form action='index.php?p=news_manage&do=save&key=<?php echo $article['num']; ?>' method='post' name='theAdminForm' id='theAdminForm'>
<div class='tableborder'>
<div class='tableheaderalt'>Editar art&iacute;culo: <?php echo $article['title']; ?></div>

<table width='100%' cellspacing='0' cellpadding='5' align='center' border='0'>
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>T&iacute;tulo</b><div class='graytext'>El t&iacute;tulo completo de tu art&iacute;culo.</div></td>
...
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Categor&iacute;a de la noticia</b></td>
...
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Topstory Image</b><div class='graytext'>URL de la imagen destacada.</div></td>
...
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Resumen</b><div class='graytext'>Una breve introducci&oacute;n al art&iacute;culo.<br />El HTML no est&aacute; permitido aqu&iacute;.</div></td>
...
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Art&iacute;culo</b><div class='graytext'>El contenido de la noticia.<br />El HTML s&iacute; est&aacute; permitido aqu&iacute;.</div></td>
...
<tr>
<tr><td align='center' class='tablesubheader' colspan='2' ><input type='submit' value='Actualizar art&iacute;culo' class='realbutton' accesskey='s'></td></tr>
</form></table></div><br />
<?php } ?>
	 </div><!-- / RIGHT CONTENT BLOCK -->
	 </td></tr>
