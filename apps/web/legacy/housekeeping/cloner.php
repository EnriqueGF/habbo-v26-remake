...
if(isset($_POST['query'])){
	...
	if($results > 0){
		$msg = "Mostrando resultados de b&uacute;squeda.";
	} else {
...
<div class='tableheaderalt'>Detector de clones</div>

<table width='100%' cellspacing='0' cellpadding='5' align='center' border='0'>
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><strong>IP Address</strong><div class='graytext'>La direcci&oacute;n IP de la que quieres obtener las cuentas. Puedes encontrar la IP de un usuario usando la herramienta <a href='index.php?p=ip'>de direcci&oacute;n IP</a>.</div></td>
<td class='tablerow2'  width='60%'  valign='middle'><input type='text' name='query' value="<?php echo $query; ?>" size='30' class='textinput'></td>
</tr>

<tr>
<tr><td align='center' class='tablesubheader' colspan='2' ><input type='submit' value='Buscar' class='realbutton' accesskey='s'></td></tr>
</form></table></div><br />
...
<?php if($results > 0){ ?>
 ...
 <tr>
  ...
  <td class='tablesubheader' width='30%' align='center'>Fecha de registro</td>
...
while($row = mysql_fetch_assoc($get_users)){
  ...
  <td class='tablerow2' align='center'><a href='index.php?p=edituser&key=%s'><img src='./images/edit.gif' alt='Editar datos del usuario'></a></td>
