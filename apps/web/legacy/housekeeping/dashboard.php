...
<tr>
 ...
 <tr>
  ...
  <td class='homepage_sub_row'>
  	<?php echo mysql_evaluate("SELECT COUNT(*) FROM users") . " (<a href='index.php?p=onlinelist'>" . $onlineUsers . "</a> en l&iacute;nea)"; ?>
  </td>
 </tr>
 <tr>
  ...
  <td class='homepage_sub_row'>
	...
	(de las cuales <?php echo mysql_evaluate("SELECT COUNT(*) FROM rooms WHERE owner IS NULL"); ?> Salas P&uacute;blicas)
  </td>
 </tr>
 <tr>
...
<div><br /><input type='submit' value='Guardar notas' class='realbutton' /></div>
			  ...
			  <td width='50%' valign='top'>
			  	<div class='homepage_border'>
 <div class='homepage_sub_header'><?php echo $sitename; ?> Administradores</div>
 <table width='100%' cellpadding='4' cellspacing='0'>
<?php
