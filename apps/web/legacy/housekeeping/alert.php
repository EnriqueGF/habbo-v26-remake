...
if(isset($_POST['alert'])){
    ...
    if($valid > 0){
        ...
        if(is_numeric($userid)){
            ...
            $msg = "Aviso enviado al usuario.";
            if($_POST['musalert'] == "on"){
                @SendMUSData('HKMW' . $userid . chr(2) . $alert);
            }
        } else {
            $msg = "Error al procesar el usuario";
        }
    } else {
...
<div class='tableheaderalt'>Avisar al usuario</div>

<table width='100%' cellspacing='0' cellpadding='5' align='center' border='0'>

<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Nombre de usuario</b><div class='graytext'>El nombre del usuario al que quieres enviar este aviso.</div></td>
...
<tr>
<td class='tablerow1' width='40%' valign='middle'><strong>Aviso del servidor</strong><div class='graytext'>Si marcas esto, el aviso tambi&eacute;n se enviar&aacute; al usuario en el servidor como alerta MOD. En ese caso, no uses HTML.</div></td>
...
<tr>
<tr><td align='center' class='tablesubheader' colspan='2' ><input type='submit' value='Enviar aviso' class='realbutton' accesskey='s'></td></tr>
