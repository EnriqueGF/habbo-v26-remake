		...
		if($rank > 0 && $rank < 8){
			if($rank > 6 && $sysadmin == $my_id || $rank < 7){
				if($sysadmin == $drow['id']){
					...
					$msg = "Acceso denegado. No puedes modificar el rango del Administrador del Sistema.";
				} else {
				...
				$msg = "Acceso denegado. Solo el Administrador del Sistema puede otorgar el rango de administrador.";
			}
		} else {
			$msg = "Rango inv&aacute;lido. Solo los rangos del 1 al 7 son v&aacute;lidos.";
		}
	} else {
		$msg = "No existe ning&uacute;n usuario con este nombre o ID.";
	}
...
<div class='tableheaderalt'>Gestor de rangos</div>

<table width='100%' cellspacing='0' cellpadding='5' align='center' border='0'>
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><strong>Nombre de usuario</strong><div class='graytext'>El nombre de usuario al que se aplicar&aacute; esta acci&oacute;n.</div></td>
<td class='tablerow2'  width='60%'  valign='middle'><input type='text' name='name' value="" size='30' class='textinput'></td>
</tr>

<tr>
<td class='tablerow1'  width='40%'  valign='middle'><strong>Rango</strong><div class='graytext'>El rango num&eacute;rico que deseas asignar al usuario. Los rangos del 1 al 7 son v&aacute;lidos.</div></td>
<td class='tablerow2'  width='60%'  valign='middle'><input type='text' name='rank' value="" size='3' maxlength='1' class='textinput'></td>
</tr>

<tr>
<tr><td align='center' class='tablesubheader' colspan='2' ><input type='submit' value='Cambiar rango' class='realbutton' accesskey='s'></td></tr>
</form></table></div><br />
...
?>
 ...
 <div class='tableborder'>
 <div class='tableheaderalt'>Miembros del personal</div>
 <table cellpadding='4' cellspacing='0' width='100%'>
 <tr>
  <td class='tablesubheader' width='60%' align='center'>Nombre de usuario</td>
  <td class='tablesubheader' width='40%' align='center'>Rango</td>
 </tr>
<?php
