...
<?php @include('sitemenu.php'); ?>
 ...
 <tr>
  ...
  <td class='tablesubheader' width='8%' align='center'>Tipo</td>
  <td class='tablesubheader' width='7%' align='center'>ID recomendado</td>
...
while($row = mysql_fetch_assoc($get_rooms)){ ?>
 <tr>
  ...
  <td class='tablerow2' align='center'><a href='index.php?p=recommendede&key=<?php echo $row['id']; ?>&a=edit'><img src='./images/edit.gif' alt='Editar recomendado'></a> <a href='index.php?p=recommendede&key=<?php echo $row['id']; ?>&a=delete'><img src='./images/delete.gif' alt='Eliminar recomendado'></a></td>
</tr>
<?php } ?>
