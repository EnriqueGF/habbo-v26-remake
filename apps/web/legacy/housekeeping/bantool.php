    ...
    if(!is_numeric($_POST['uid'])){
        ...
        if($valid < 1){
            ...
            if($length == "2h"){
                ...
                $msg = "Duraci&oacute;n de baneo inv&aacute;lida";
            }
            ...
            if($uid !== $sysadmin || $my_id == $sysadmin){
                ...
                $msg = "El usuario " . $tmp['name'] . " ha sido baneado hasta " . $ban_date . " correctamente. Se ha enviado una notificaci&oacute;n en el juego (si el usuario estaba conectado).";
                @SendMUSData('HKSB' . $uid . chr(2) . $reason);
            } else {
                $msg = "No puedes banear al administrador del sistema";
...
<div class='tableheaderalt'>Baneo (remoto)</div>

<table width='100%' cellspacing='0' cellpadding='5' align='center' border='0'>
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>ID de usuario</b><div class='graytext'>El ID del usuario que quieres banear. Para buscar el ID de un usuario, usa <a href='index.php?p=uid'>la herramienta de ID</a>.</div></td>
<td class='tablerow2'  width='60%'  valign='middle'><input type='text' name='uid' value="<?php echo $_POST['uid']; ?>" size='30' class='textinput'></td>
</tr>

<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Motivo del baneo</b><div class='graytext'>El motivo del baneo que se mostrar&aacute; al usuario.</div></td>
...
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Direcci&oacute;n IP</b> (opcional)<div class='graytext'>Si tambi&eacute;n quieres banear la IP del usuario, rellena este campo. Para buscar la IP, usa <a href='index.php?p=ip'>la herramienta de IP</a>.</div></td>
<td class='tablerow2'  width='60%'  valign='middle'><input type='text' name='ip' value="<?php echo $_POST['ip']; ?>" size='30' class='textinput'></td>
</tr>

<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Duraci&oacute;n del baneo</b></td>
<td class='tablerow2'  width='60%'  valign='middle'><select name='length'  class='dropdown'>
                                                                        <?php if(isset($_POST['length'])){ echo "<option value='".$_POST['length']."'>No cambiar (".$_POST['length'].")</option>"; } ?>
									<option value='2h'>2 horas</option>
									<option value='4h'>4 horas</option>
                                                                        <option value='12h'>12 horas</option>
                                                                        <option value='1d'>24 horas</option>
                                                                        <option value='2d'>2 d&iacute;as</option>
                                                                        <option value='7d'>7 d&iacute;as</option>
                                                                        <option value='2w'>2 semanas</option>
                                                                        <option value='1m'>1 mes</option>
                                                                        <option value='6m'>6 meses</option>
                                                                        <option value='1y'>1 a&ntilde;o</option>
                                                                        <option value='perm'>Permanente (25 a&ntilde;os)</option>
								    </select>
...
<tr>
<tr><td align='center' class='tablesubheader' colspan='2' ><input type='submit' value='Banear' class='realbutton' accesskey='s'></td></tr>
