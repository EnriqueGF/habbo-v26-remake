...
<?php @include('sitemenu.php'); ?>
 ...
 <div class='tableheaderalt'><?php echo $sitename; ?> - Noticias destacadas</div>
 <table cellpadding='4' cellspacing='0' width='100%'>
 <tr>
  <td class='tablesubheader' width='1%' align='center'>ID</td>
  <td class='tablesubheader' width='8%' align='center'>Nombre</td>
  <td class='tablesubheader' width='7%' align='center'>Enlace</td>
