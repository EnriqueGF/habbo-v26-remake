...
$msg = "Optimizando tablas..</strong>";
$getTables = mysql_query("SHOW TABLES FROM " . $sqldb) or die(mysql_error());
    while($tmp = mysql_fetch_array($getTables)){
        $table = $tmp[0];
        $msg = $msg . "<br />Optimizando tabla " . $tmp[0] . "..";
        mysql_query("OPTIMIZE TABLE " . $tmp[0]) or die(mysql_error());
        $msg = $msg . "<strong>OK!</strong>";
    }
$msg = $msg . "<br /><br />&iexcl;Tablas de la base de datos optimizadas correctamente!<strong>";
