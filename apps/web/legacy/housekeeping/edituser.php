...
if(isset($userid)){
	...
	if(is_numeric($userid)){
		...
		if($found > 0){
			...
			$msg = "Usuario no encontrado. Comprueba el ID de usuario.";
		}
	} else {
		$msg = "ID de usuario inv&aacute;lido. Debe ser un valor num&eacute;rico v&aacute;lido.";
	}
...
if(isset($_POST['hiddenHook']) && $showeditor == true){
        ...
        // Set $msg
        $msg = "Usuario actualizado correctamente. El usuario tambi&eacute;n se actualizar&aacute; en el juego si est&aacute; conectado.<br />";
...
<div class='tableheaderalt'>Editar usuario</div>
...
<tr>
<tr><td align='center' class='tablesubheader' colspan='2' ><input type='submit' value='Guardar usuario' class='realbutton' accesskey='s'></td></tr>
</form></table></div><br />
<?php } else { ?>
...
<table width='100%' cellspacing='0' cellpadding='5' align='center' border='0'>
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Nombre de usuario</b><div class='graytext'>El nombre del usuario que quieres editar.</div></td>
...
<tr>
<tr><td align='center' class='tablesubheader' colspan='2' ><input type='submit' value='Buscar usuario' class='realbutton' accesskey='s'></td></tr>
</form></table></div><br />
