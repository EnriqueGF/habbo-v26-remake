...
<div class="topiclist-header clearfix">
        ...
        <?php if($logged_in){ ?><a href="#" id="newtopic-upper" class="new-button verify-email newtopic-icon" style="float:left"><b><span></span>Nuevo tema</b><i></i></a><?php } ?>
...
<div class="topiclist-footer clearfix">
        <?php if($logged_in){ ?><a href="#" id="newtopic-lower" class="new-button verify-email newtopic-icon" style="float:left"><b><span></span>Nuevo tema</b><i></i></a><?php } else { echo "Debes estar conectado para publicar temas."; } ?>
    <div class="page-num-list">
    P&aacute;g.
<?php
	for ($i = 1; $i <= $pages; $i++){
