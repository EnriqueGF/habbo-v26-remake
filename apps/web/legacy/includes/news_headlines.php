...
if(empty($news_1_title)){ $news_1_title = "Noticia no encontrada"; }
if(empty($news_1_snippet)){ $news_1_snippet = "Este art&iacute;culo no existe."; }
...
if(empty($news_2_title)){ $news_2_title = "Noticia no encontrada"; }
if(empty($news_2_snippet)){ $news_2_snippet = "Este art&iacute;culo no existe."; }
...
if(empty($news_3_title)){ $news_3_title = "Noticia no encontrada"; }
if(empty($news_3_date)){ $news_3_date = "Este art&iacute;culo no existe."; }
...
if(empty($news_4_title)){ $news_4_title = "Noticia no encontrada"; }
if(empty($news_4_date)){ $news_4_date = "Este art&iacute;culo no existe."; }
