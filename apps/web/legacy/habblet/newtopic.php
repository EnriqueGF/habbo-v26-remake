...
<tr class="new-topic-entry-label" id="new-topic-entry-label">
	<td class="new-topic-entry-label">Tema:</td>
	<td colspan="2">
...
<tr id="new-post-entry-message" style="display:none;">
	...
	<td colspan="2">
        ...
        <a href="#" class="preview-post-link" id="topic-form-preview">Vista previa &raquo;</a>
    ...
    <script type="text/javascript">
	    ...
	    <br /><br/>
        <a class="new-button red-button cancel-icon" href="forum.php"><b><span></span>Salir</b><i></i></a>
...
<tr id="new-post-entry-message" style="display:none;">
    ...
    <script type="text/javascript">
	    ...
	    <br /><br/>
        <a class="new-button red-button cancel-icon" href="forum.php"><b><span></span>Cancelar</b><i></i></a>
        <a id="topic-form-save" class="new-button green-button save-icon" href="#"><b><span></span>Guardar</b><i></i></a>
        </td>
        </tr>
        </table>
