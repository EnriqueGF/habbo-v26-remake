...
if(empty($topicName)){ $topicName = "Vista previa del mensaje"; }
...
<tr class=\"post-list-index-preview\">
	<td class=\"post-list-row-container\">
		...
		<div class=\"post-list-posts post-list-creator-info\">Mensajes: ".$myrow['postcount']."</div>
		<div class=\"clearfix\">
            <div class=\"post-list-creator-avatar\"><img src=\"/habbo-imaging/avatarimage?figure=".$myrow['figure']."&size=b&direction=2&head_direction=2&gesture=sml\" alt=\"".$userdata['name']."\" /></div>
...
echo "</div>
	...
	<td class=\"post-list-message\" valign=\"top\" colspan=\"2\">
            <a href=\"#\" id=\"edit-post-message\" class=\"resume-edit-link\">&laquo; Editar</a>
	...
	<div>&nbsp;</div><div>&nbsp;</div>
        ...
        <div>\n";
			if($x == "topic"){
		        echo "<a id=\"topic-form-cancel-preview\" class=\"new-button red-button cancel-icon\" href=\"#\"><b><span></span>Salir</b><i></i></a>
		        <a id=\"topic-form-save-preview\" class=\"new-button green-button save-icon\" href=\"#\"><b><span></span>Guardar</b><i></i></a>            ";
			} else {
			  echo "<a id=\"post-form-cancel\" class=\"new-button red-button cancel-icon\" href=\"#\"><b><span></span>Salir</b><i></i></a>
