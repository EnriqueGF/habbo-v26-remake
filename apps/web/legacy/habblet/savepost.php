...
while($row = mysql_fetch_assoc($get_em)){
	...
	<td class=\"post-list-message\" valign=\"top\" colspan=\"2\">
			...
			if($user_rank > 5 || $my_id == $userdata['id']){
	                echo "<a href=\"#\" class=\"edit-post-link verify-email\" id=\"edit-post-".$row['id']."-message\">Modificar</a>";
			}
...
echo "        </div>";
		...
		echo "\n<br /><br /><font size='1'><strong>&Uacute;ltima modificaci&oacute;n: ".$row['edit_date']." por ".$row['edit_author']."</strong></font>";
		}
...
<tr id="new-post-entry-message" style="display:none;">
	...
	<td colspan="2">
        ...
        <input type="hidden" id="spam-message" value="&iexcl;Alarma de spam!"/>
