...
$tag_1 = "<b>" . $_POST['tag1'] . "</b>";
$tag_2 = $_POST['tag2'];
$end = 2;
} elseif($tag_1_results < $tag_2_results){
$tag_1 = $_POST['tag1'];
$tag_2 = "<b>" . $_POST['tag2'] . "</b>";
$end = 1;
}
...
echo "			<div id=\"fightResultCount\" class=\"fight-result-count\">
			...
			<div class=\"fight-image\">
                ...
                <a id=\"tag-fight-button\" href=\"#\" style=\"display:none\" class=\"new-button\" onclick=\"TagFight.init(); return false;\"><b>Empezar</b><i></i></a>
            </div>
";
