...
if($is_member > 0){
	...
	echo "No se han podido guardar los ajustes del grupo\n\n<p>\n<a href=\"group_profile.php?id=".$groupid."\" class=\"new-button\"><b>Hecho</b><i></i></a>\n</p>\n\n<div class=\"clear\"></div>";
	exit;
}
...
if($groupdata['type'] == "3" && $_POST['type'] !== "3"){ echo "No puedes cambiar el tipo de grupo si est&aacute; configurado como ilimitado."; exit; } // you can't change the group type once you set it to 4, fool
if($type < 0 || $type > 3){ echo "Tipo de grupo no v&aacute;lido."; exit; } // this naughty user doesn't even deserve an settings update

if(strlen(HoloText($name)) > 25){
	echo "El nombre es demasiado largo\n\n<p>\n<a href=\"group_profile.php?id=".$groupid."\" class=\"new-button\"><b>Hecho</b><i></i></a>\n</p>\n\n<div class=\"clear\"></div>";
} elseif(strlen(HoloText($description)) > 200){
	echo "La descripci&oacute;n es demasiado larga\n\n<p>\n<a href=\"group_profile.php?id=".$groupid."\" class=\"new-button\"><b>Hecho</b><i></i></a>\n</p>\n\n<div class=\"clear\"></div>";
	...
	echo "Ajustes del grupo guardados correctamente\n\n<p>\n<a href=\"group_profile.php?id=".$groupid."\" class=\"new-button\"><b>Hecho</b><i></i></a>\n</p>\n\n<div class=\"clear\"></div>";
}
?>