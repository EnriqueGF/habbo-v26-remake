...
header("X-JSON: {\"pending\":\"Solicitudes pendientes (" . $members_pending . ")\",\"members\":\"Miembros (" . $members . ")\"}");
...
<ul class=\"habblet-list two-cols clearfix\">\n";
	...
	if($pending == true){
		if($members_pending < 1){
			echo "No hay solicitudes de membres&iacute;a pendientes en este momento. Vuelve a comprobarlo m&aacute;s tarde.";
		} else {
    	...
    	<div class=\"item\" style=\"padding-left: 5px; padding-bottom: 4px;\">
    		<div style=\"float: right; width: 16px; height: 16px; margin-top: 1px\">\n";
				if($membership['userid'] == $groupdata['ownerid']){ echo "<img src=\"./web-gallery/images/groups/owner_icon.gif\" width=\"15\" height=\"15\" alt=\"Propietario\" title=\"Propietario\" />\n"; }
				elseif($membership['member_rank'] > 1){ echo "<img src=\"./web-gallery/images/groups/administrator_icon.gif\" width=\"15\" height=\"15\" alt=\"Administrador\" title=\"Administrador\" />"; }
			echo "</div>
		...
		if($members < 1){
			echo "No hay miembros en este momento. Vuelve a comprobarlo m&aacute;s tarde.";
		} else {
    	...
    	<div class=\"item\" style=\"padding-left: 5px; padding-bottom: 4px;\">
    		<div style=\"float: right; width: 16px; height: 16px; margin-top: 1px\">\n";
				if($membership['userid'] == $groupdata['ownerid']){ $tinyrank = "a"; echo "<img src=\"./web-gallery/images/groups/owner_icon.gif\" width=\"15\" height=\"15\" alt=\"Propietario\" title=\"Propietario\" />\n"; }
				elseif($membership['member_rank'] > 1){ $tinyrank = "a"; echo "<img src=\"./web-gallery/images/groups/administrator_icon.gif\" width=\"15\" height=\"15\" alt=\"Administrador\" title=\"Administrador\" />"; }
			echo "</div>
...
if($page > 1){ echo "<a href=\"#\" class=\"avatar-list-paging-link\" id=\"memberlist-search-first\" >Primera</a>"; } else { echo "Primera"; }
echo " | ";
...
echo " | ";
if($page < $totalPagesMemberList){ echo "<a href=\"#\" class=\"avatar-list-paging-link\" id=\"memberlist-search-last\" >&Uacute;ltima</a>"; } else { echo "&Uacute;ltima"; }
