...
$oddeven = 0;
	...
	if($results > 0){
		...
		echo "<ul id=\"quickmenu-" . $str . "\">\n	<li class=\"odd\">Todav&iacute;a no tienes ning&uacute;n " . $str . "</li>\n</ul>";
	}

	if($mode == "3"){
	echo "<p class=\"create-room\"><a href=\"client.php?shortcut=roomomatic\" onclick=\"HabboClient.openShortcut(this, 'roomomatic'); return false;\" target=\"client\">Crear una sala nueva</a></p>";
	} elseif($mode == "2"){
