...
if(!session_is_registered(username)){ echo "<p>\n&iexcl;Inicia sesi&oacute;n primero!\n</p>\n\n<p>\n<a href=\"#\" class=\"new-button\" onclick=\"habboclub.closeSubscriptionWindow(); return false;\"><b>OK</b><i></i></a>\n</p>"; exit; }
...
if($myrow['credits'] < $price){
	$msg = "No tienes suficientes cr&eacute;ditos para suscribirte al HC";
} else {
	...
	if(getContent('hc-maxmonths') == "0" || $months_left < getContent('hc-maxmonths')){
		...
		$msg = "&iexcl;Genial! Ahora eres miembro del ".$shortname." Club durante ".$months." mes(es).";
	} else {
		$msg = "Solo puedes suscribirte por un m&aacute;ximo de ".getContent('hc-maxmonths')." mes(es). Si completaras esta suscripci&oacute;n, superar&iacute;as el l&iacute;mite.";
	}
}
