...
<div id="column1" class="column">
				...
				<div class="habblet-container ">		
						<div class="cbb clearfix pixelblue ">
							...
							<h2 class="title">&iexcl;Aprende c&oacute;mo ganar p&iacute;xeles! 
							</h2>
...
<div id="column2" class="column">
				...
				<div class="habblet-container ">		
						<div class="cbb clearfix pixelgreen ">
							...
							<h2 class="title">&iexcl;Para alquilar! 
							</h2>
    ...
    <div class="pixels-info-text clearfix">
        ...
        <p class="pixels-text">&iexcl;Sorprende a todos en tu sala con eventos especiales!
</p>
    </div>
</div>
				...
				<div class="habblet-container ">		
						<div class="cbb clearfix pixellightblue ">
							...
							<h2 class="title">&iquest;Efectos?
							</h2>
						<div id="pixels-info" class="box-content pixels-info">
    <div class="pixels-info-text clearfix">
        <img class="pixels-image" src="./web-gallery/v2/images/activitypoints/pixelpage_personaleffect.png" alt=""/>
        <p class="pixels-text">Equipa a tu <?php echo $shortname; ?> para que luzca en cualquier ocasi&oacute;n. &iquest;Quieres ser el centro de atenci&oacute;n? &iexcl;Esta es tu oportunidad!</p>
    </div>
				...
				<div class="habblet-container ">		
						<div class="cbb clearfix pixeldarkblue ">
							...
							<h2 class="title">&iquest;Buenas ofertas? 
							</h2>
						<div id="pixels-info" class="box-content pixels-info">
    <div class="pixels-info-text clearfix">
