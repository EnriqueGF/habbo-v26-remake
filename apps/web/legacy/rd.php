...
<p class="btn">Si no se te redirige autom&aacute;ticamente, haz <a href="user_profile.php?tag=<?php echo $row['name']; ?>" id="manual_redirect_link">clic aqu&iacute;</a></p>
...
<p class="btn">Si no se te redirige autom&aacute;ticamente, haz <a href="index.php" id="manual_redirect_link">clic aqu&iacute;</a></p>
