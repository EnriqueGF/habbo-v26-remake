    ...
    <div id="column1" class="column">
				<div class="habblet-container ">
						<div class="cbb clearfix default ">
							...
							<h2 class="title">Etiquetas aleatorias
							</h2>
    ...
    <?php @include('tagcloud.php'); ?>
				...
				<div class="habblet-container ">
						<div class="cbb clearfix default ">
							...
							<h2 class="title">Duelo de etiquetas
							</h2>
...
<div id="column2" class="column">
				<div class="habblet-container ">
						<div class="cbb clearfix default ">
							...
							<h2 class="title">Buscar etiquetas <?php if($valid_search == true){ echo "(" . $results . ")"; } ?>
							</h2>
...
</form>        <?php if($results > 0){ echo "<br /><p class=\"search-result-count\">1 - " . $results . " / " . $results . "</p>"; } else { echo "<p class=\"search-result-count\">Sin resultados.</p>"; } ?>
                <?php if($valid_search == true && $logged_in == true && $valid_tag == true && $already_tagged == false){ echo "<p id=\"tag-search-add\" class=\"clearfix\"><span style=\"float:left\">&iquest;A&ntilde;adir esta etiqueta?</span> <a id=\"tag-search-tag-add\" href=\"tags.php?tag=".trim(HoloText($query))."&add=true\" class=\"new-button\" style=\"float:left\"><b>".trim(HoloText($query))."</b><i></i></a></p>"; } ?>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="search-result">
        ...
        <?php
                ...
                <td class=\"image\" style=\"width:39px;\">
                    <img src=\"/habbo-imaging/avatarimage?figure=".$userdata['figure']."&size=s&direction=4&head_direction=4&gesture=sml\" alt=\"".$userdata['name']."\" align=\"left\"/>
                </td>
                <td class=\"text\">
