...
<div id="faq-header" class="clearfix"><img src="./web-gallery/v2/images/faq/faq_header.png" /><form method="post" action="./help.php" class="search-box"><input type="text" id="faq-search" name="query" class="search-box-query search-box-onfocus" size="50" value="Buscar..."/><input type="submit" value="" title="Buscar" class="search" /></form></div>
