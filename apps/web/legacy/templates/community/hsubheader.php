...
function isElementLimitReached() {
	if (getElementCount() >= 200) {
		showHabboHomeMessageBox("Error", "Ya has colocado el m&aacute;ximo de elementos en la p&aacute;gina. Quita una pegatina, nota o widget para poder colocar este elemento.", "Cerrar");
		return true;
	}
	return false;
}
...
function showEditErrorDialog() {
	...
	Dialog.setDialogBody(dialog, '<p>&iexcl;Ha ocurrido un error! Int&eacute;ntalo de nuevo en unos minutos.</p><p><a href="#" class="new-button" id="myhabbo-error-close"><b>Cerrar</b><i></i></a></p><div class="clear"></div>');
...
function showSaveOverlay() {
	...
	if (invalidPos.length > 0) {
		showHabboHomeMessageBox("&iexcl;Vaya!", "Lo sentimos, pero no puedes colocar tus pegatinas, notas o widgets aqu&iacute;. Cierra la ventana para seguir editando tu p&aacute;gina.", "Cerrar");
...
<meta name="description" content="<?php echo $sitename; ?> es un mundo virtual donde puedes conocer gente y hacer amigos." />
<meta name="keywords" content="<?php echo $sitename; ?>,<?php echo $shortname; ?>,mundo virtual,jugar,concursos,hacer amigos" />
