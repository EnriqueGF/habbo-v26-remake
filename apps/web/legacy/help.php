...
$i = 0;
	...
	<div id=\"faq-close-button-".$itemrow['id']."\" class=\"faq-close-button clearfix faq-toggle\" style=\"display:none\">Cerrar FAQ <img id=\"faq-close-image-".$itemrow['id']."\" class=\"faq-toggle\" src=\"./web-gallery/v2/images/faq/close_btn.png\"/></div>
	</div>
	</div>
...
if($count == 0){;
	echo "No se encontraron resultados. Busca de nuevo.";
}else{
	while($itemrow = mysql_fetch_assoc($sql)){
