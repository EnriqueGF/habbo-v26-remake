...
using Holo.Virtual;
// Microsoft.VisualBasic removed for Mono compatibility
...
namespace Holo.Virtual.Users
{
    ...
    public class virtualUser
    {
        ...
        private void dataArrival(IAsyncResult iAr)
        {
            ...
            catch (Exception _ex) { Out.WriteError("dataArrival exception: " + _ex.ToString()); Disconnect(); }
        }
        #endregion
